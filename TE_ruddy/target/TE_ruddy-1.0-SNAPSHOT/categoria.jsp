...
<html>
    ...
    <br>
     <a href="LibroController" class="link-success link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">Libro</a>
        
    </center>
    <br>

    <center><table border="1" cellspacin="0" class="table table-dark table-hover">
            <tr>
                <th>Id</th>
                <th>Categoria</th>
